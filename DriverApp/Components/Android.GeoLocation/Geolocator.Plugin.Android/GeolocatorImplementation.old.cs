  ...
  /// </summary>
    public class GeolocatorImplementation : IGeolocator
    {
        public GeolocatorImplementation()
        {
            ...
            this.providers = this.manager.GetProviders(criteriaForLocationService, true).ToArray();
            ...
            if (!IsListening)
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < this.providers.Length; ++i)
                    {
                        ...
                        this.manager.RequestLocationUpdates(this.providers[i], 1000, 1, singleListener, looper);
                    }
